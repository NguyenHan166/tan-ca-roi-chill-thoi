    ...
    >
      ...
      <button
        ...
        className={`absolute top-4 right-4 z-10 w-8 h-8 rounded-full shadow-sm flex items-center justify-center transition-all duration-300 hover:scale-105 cursor-pointer border ${
          ...
          isFavorited ? 'text-red-500' : activeTheme === 'evening' ? 'text-[#EBE4DC]/40 hover:text-red-500' : 'text-cozy-dark/30 hover:text-red-500'
        }`}
      ...
      <div className="relative aspect-[4/3] sm:aspect-[16/11] overflow-hidden bg-cozy-cream/10 shrink-0">
        ...
        <span className={`absolute bottom-3 left-3 inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase border ${
          activeTheme === 'evening'
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
        <div className="space-y-2">
          ...
          <div className={`flex items-center justify-between text-xs font-mono tracking-wider font-bold ${
          ...
          {/* Poetical Name */}
          <h4 className={`font-serif text-base sm:text-lg font-bold italic leading-snug transition-colors line-clamp-1 ${
          ...
          {/* Handpicked note */}
          <p className={`text-xs sm:text-sm font-serif italic leading-relaxed line-clamp-1 border-l-2 pl-2 ${
            activeTheme === 'evening' ? 'text-cozy-warm-yellow/90 border-cozy-warm-yellow/30' : 'text-cozy-wood/90 border-cozy-wood/30'
          }`}>
            “ {product.tagline} ”
          </p>
          ...
          <p className={`text-xs leading-relaxed line-clamp-2 ${
            activeTheme === 'evening' ? 'text-[#EBE4DC]/70' : 'text-cozy-dark/75'
          }`}>
            {product.description}
          </p>
        </div>
        ...
        <div className={`pt-3 border-t flex flex-col gap-2 ${
          activeTheme === 'evening' ? 'border-[#5A483B]/30' : 'border-cozy-wood/10'
        }`}>
          <div className="flex items-center justify-between">
            ...
            <span className={`text-[10px] font-bold tracking-wider uppercase px-2.5 py-0.5 rounded-full ${
              activeTheme === 'evening' ? 'bg-cozy-warm-yellow/10 text-cozy-warm-yellow' : 'bg-cozy-moss/10 text-cozy-moss'
            }`}>
              {product.badge}
            </span>
          </div>
          ...
          <p className={`text-[10px] text-center italic tracking-tight font-sans ${
            activeTheme === 'evening' ? 'text-[#EBE4DC]/30' : 'text-cozy-dark/40'
          }`}>
