...
import imageData from "../image-data/image.png";
...
const deskAngles: DeskAngle[] = [
    {
        ...
        mainQuote:
            "“ Đây là chốn bình yên của mình. Nơi deadline khép lại, ngọn đèn sồi bật lên và những ước mơ mộc mạc bắt đầu bay bổng. ”",
        tagline:
            "Khi nắng vàng cam lịm dần sau những tòa cao ốc, góc nhỏ này luôn đợi mình về gác lại mọi băn khoăn.",
        bullets: [
    ...
    },
    {
        ...
        mainQuote:
            "“ Chiếc tổ nhỏ ẩn náu khỏi giông bão cuộc đời. Tiếng mưa dội lên mái hiên cũng là lúc tâm hồn mình được vỗ về dịu dàng nhất. ”",
        tagline:
            "Bất kể ngoài kia mưa rào trắng lối, căn phòng nhỏ này vẫn thắp lên ngọn nến thơm thảo mộc ấm áp.",
        bullets: [
    ...
    },
    {
        ...
        mainQuote:
            "“ Tối giản không gian để dọn dẹp tâm trí. Chỉ một nhành cây xanh mướt và tách đen nóng là đủ thắp sáng cả một ngày dài tích cực. ”",
        tagline:
            "Bớt đi những chi tiết dư thừa, nhường chỗ cho sự tập trung và những ý tưởng mượt mà tuôn trào.",
        bullets: [
...
export const MyDeskShowcase: React.FC<MyDeskShowcaseProps> = ({
    activeTheme,
    onToast,
}) => {
    ...
    const handleLikeAngle = (id: string, e: React.MouseEvent) => {
        ...
        if (hasLiked[id]) {
            ...
            onToast(
                `Bạn đã thả tim góc này! Cảm ơn sự đồng điệu nhé ❤️`,
                "heart",
            );
        }
    };
    ...
    return (
        <div
            className={`w-full border rounded-3xl p-6 md:p-10 flex flex-col gap-10 shadow-md relative overflow-hidden bg-grain transition-all duration-[1200ms] ${
                activeTheme === "evening"
        ...
        >
            ...
            <div className="text-center max-w-xl mx-auto space-y-3">
                <h3
                    className={`font-serif text-3xl md:text-4xl font-semibold transition-colors ${
                        activeTheme === "evening"
                            ? "text-[#EBE4DC]"
                            : "text-cozy-dark"
                    }`}
                >
                    Góc Nhỏ Bình Yên Của Mình
                </h3>
                <p
                    className={`text-sm md:text-base leading-relaxed font-sans max-w-lg mx-auto transition-colors ${
                        activeTheme === "evening"
                            ? "text-[#EBE4DC]/80"
                            : "text-cozy-dark/85"
                    }`}
                >
                    Mỗi bức ảnh dưới đây đại diện cho một góc bàn làm việc thực
                    tế nơi mình thả neo tâm hồn sau những giờ tan ca hối hả. Hãy
                    chạm để thay đổi góc nhìn và lắng nghe những câu chuyện thầm
                    lặng nhé.
                </p>
            </div>
                    ...
                    <div className="w-full max-w-md relative">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div
                                    className={`border rounded-3xl p-4 sm:p-5 shadow-xl hover:shadow-2xl transition-all duration-500 group cursor-pointer relative overflow-hidden ${
                                        activeTheme === "evening"
                                ...
                                >
                                    ...
                                    <div
                                        className={`aspect-[4/3] rounded-2xl overflow-hidden relative border ${
                                            activeTheme === "evening"
                                                ? "bg-[#241D19] border-[#5A483B]/20"
                                                : "bg-cozy-cream border-cozy-wood/10"
                                        }`}
                                    >
                                        <motion.img
                                        ...
                                        <div className="absolute top-3 right-3 bg-cozy-dark/70 backdrop-blur-md border border-white/10 text-white rounded-full px-2.5 py-1 text-[9px] font-mono tracking-widest uppercase flex items-center gap-1">
                                            <Camera
                                                size={10}
                                                className="text-cozy-warm-yellow"
                                            />
                                    ...
                                    <div className="pt-4 flex items-center justify-between">
                                        <div>
                                            <p
                                                className={`font-serif italic text-base font-bold transition-colors ${
                                                    activeTheme === "evening"
                                            ...
                                            <p
                                                className={`text-[10px] sm:text-xs font-sans tracking-wide transition-colors ${
                                                    activeTheme === "evening"
                                                        ? "text-[#EBE4DC]/50"
                                                        : "text-cozy-dark/50"
                                                }`}
                                            >
                                                Ảnh thực tế được chụp bằng máy
                                                phim cơ
                                            </p>
                                        </div>
                                        ...
                                        >
                                            <Heart
                                                ...
                                                className={`transition-transform duration-300 ${
                                                    hasLiked[activeAngle.id]
                                                        ? "scale-110 text-white fill-white"
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                ...
                                <h4
                                    className={`font-serif text-xl sm:text-2xl font-semibold italic transition-colors ${
                                        activeTheme === "evening"
                                            ? "text-[#EBE4DC]"
                                            : "text-cozy-dark"
                                    }`}
                            ...
                            <p
                                className={`font-serif text-xl sm:text-2xl leading-relaxed font-bold border-l-4 pl-5 text-justify italic transition-colors ${
                                    activeTheme === "evening"
                                        ? "text-[#EBE4DC] border-cozy-warm-yellow/40"
                                        : "text-cozy-dark border-cozy-wood/30"
                                }`}
                            >
                            ...
                            {/* Tagline text block */}
                            <p
                                className={`text-sm sm:text-base leading-relaxed font-sans text-justify transition-colors ${
                                    activeTheme === "evening"
                                        ? "text-[#EBE4DC]/80"
                                        : "text-cozy-dark/85"
                                }`}
                            ...
                            <div className="space-y-3 pt-2">
                                <p
                                    className={`text-xs uppercase tracking-widest font-mono font-bold transition-colors ${
                                        activeTheme === "evening"
                                            ? "text-[#EBE4DC]/50"
                                            : "text-cozy-dark/50"
                                    }`}
                                ...
                                {activeAngle.bullets.map((bullet, index) => (
                                    ...
                                    >
                                        ...
                                        <p
                                            className={`text-sm sm:text-base font-sans transition-colors ${
                                                activeTheme === "evening"
                                                    ? "text-[#EBE4DC]/80"
                                                    : "text-cozy-dark/80"
                                            }`}
                            ...
                            <div
                                className={`border rounded-2xl p-4 flex items-center gap-4.5 mt-4 transition-all duration-500 ${
                                    activeTheme === "evening"
                            ...
                            >
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    >
                                        Tần số đề xuất phát kèm:
                                    </p>
                                    <p
                                        className={`text-xs sm:text-sm font-bold mt-1 transition-colors ${
                                            activeTheme === "evening"
                                                ? "text-[#EBE4DC]"
                                                : "text-cozy-dark"
                                        }`}
                                    >
                                        Góc này phát cùng bản{" "}
                                        <span
