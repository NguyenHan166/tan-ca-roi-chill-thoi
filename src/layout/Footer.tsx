  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs md:text-sm text-cozy-dark/70 max-w-sm leading-relaxed font-sans">
              “Một góc nhỏ dành cho những người đã có một ngày hơi dài. Bật chút âm thanh rì rào, tựa lưng nghỉ ngơi và cảm nhận những điều nhỏ nhặt bên chiếc đèn vàng.”
            </p>

            {/* Social channels */}
            <div className="flex items-center gap-3 pt-2">
              <a
                href="https://tiktok.com/@tancaroi"
                target="_blank"
              ...
              <a
                href="https://facebook.com/tancaroi"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full border border-cozy-wood/15 hover:bg-cozy-wood hover:text-cozy-ivory flex items-center justify-center transition-all duration-300"
              ...
              <a
                href="https://instagram.com/tancaroi"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full border border-cozy-wood/15 hover:bg-cozy-wood hover:text-cozy-ivory flex items-center justify-center transition-all duration-300"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs text-cozy-dark/75">
              <li>
                <a href="#mood-selector" className="hover:text-cozy-wood transition-colors">Chọn mood cảm xúc</a>
              </li>
              <li>
                <a href="#desk-interactive" className="hover:text-cozy-wood transition-colors">Góc setup tương tác</a>
              </li>
              <li>
                <a href="#products-showcase" className="hover:text-cozy-wood transition-colors">Đồ nhỏ, mood lớn</a>
              </li>
              <li>
                <a href="#journal-section" className="hover:text-cozy-wood transition-colors">Nhật ký văn phòng</a>
              </li>
              <li>
                <a href="#collections-showcase" className="hover:text-cozy-wood transition-colors">Bộ sưu tập mộc mạc</a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs text-cozy-dark/75">
              <li>
                <a href="#affiliate-policy" className="hover:text-cozy-wood transition-colors">Chính sách Affiliate</a>
              </li>
              <li>
                <a href="#privacy" className="hover:text-cozy-wood transition-colors">Quyền riêng tư của bạn</a>
              </li>
              <li>
                <a href="#terms" className="hover:text-cozy-wood transition-colors">Điều khoản trải nghiệm</a>
              </li>
              <li>
                <a href="mailto:gocnho@tancaroi.vn" className="hover:text-cozy-wood transition-colors">Hợp tác tiếp thị</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div id="affiliate-policy" className="p-5 md:p-6 bg-cozy-cream/60 border border-cozy-wood/10 rounded-2xl">
          ...
          <p className="text-xs text-cozy-dark/70 leading-relaxed font-sans">
            Góc nhỏ <strong>“Tan Ca Rồi”</strong> hoạt động dựa trên mô hình tiếp thị liên kết (Affiliate Marketing). Một số liên kết trên trang web này (đặc biệt là các nút hướng đến TikTok Shop) là liên kết tiếp thị. Khi bạn mua hàng qua các đường link này, tụi mình có thể sẽ nhận được một khoản hoa hồng nho nhỏ từ đối tác bán hàng. Khoản phí này hoàn toàn không làm thay đổi giá bán gốc của sản phẩm đối với bạn, nhưng nó sẽ là một nguồn lực tinh thần quý báu giúp tụi mình duy trì, cải tiến trang web và tiếp tục viết nên những câu chuyện nhẹ nhàng cho mọi người. Cảm ơn bạn rất nhiều vì đã ủng hộ!
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-cozy-wood/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-cozy-dark/50">
          <div>
            &copy; {new Date().getFullYear()} Tan Ca Rồi. Đã đăng ký bản quyền.
          </div>
          <div className="flex items-center gap-1">
            <span>Làm với một chút cà phê</span>
            <span className="text-cozy-warm-yellow">&#9733;</span>
            <span>ánh đèn bàn vàng ấm và những ngày không vội vã.</span>
          </div>
        </div>
      </div>
    </footer>
