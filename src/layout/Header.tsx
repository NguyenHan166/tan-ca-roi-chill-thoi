            ...
            >
                <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
                        ...
                        {menuItems.map((item) => (
                            <button
                                ...
                                className={`cursor-pointer transition-colors relative py-1 focus:outline-none group ${
                                    activeTheme === "evening"
                                        ? "hover:text-cozy-warm-yellow"
                                        : "hover:text-cozy-wood"
                                }`}
                            >
                                {item.label}
                                <span
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <div
                            className={`hidden lg:flex items-center border rounded-full p-1 text-[10px] transition-colors ${
                                activeTheme === "evening"
                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        >
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <button
                                    ...
                                    className={`w-8 h-8 rounded-full flex items-center justify-center cursor-pointer transition-colors ${
                                        activeTheme === "evening"
                                            ? "hover:bg-[#2D231D] text-[#EBE4DC]"
                                            : "hover:bg-cozy-wood/5 text-cozy-dark"
                                    }`}
                            ...
                            <div
                                className={`mb-6 rounded-2xl p-4 border transition-colors ${
                                    activeTheme === "evening"
                            ...
                            >
                                <span
                                    className={`text-[10px] uppercase font-bold tracking-wider block mb-2 ${
                                        activeTheme === "evening"
                            ...
                            <div className="mt-auto pt-6 space-y-4">
                                ...
                                <p
                                    className={`text-[10px] text-center italic leading-normal ${
                                        activeTheme === "evening"
                                            ? "text-[#EBE4DC]/40"
                                            : "text-cozy-dark/40"
                                    }`}
                                >
                                    “Một góc nhỏ dành cho những người đã có một
                                    ngày hơi dài.”
                                </p>
                            </div>
                        </motion.div>
