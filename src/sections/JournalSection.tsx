        ...
        >
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                <div className="text-center space-y-4 max-w-xl mx-auto">
                    ...
                    <h2
                        className={`font-serif text-3xl sm:text-4xl md:text-5xl font-semibold transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]"
                                : "text-cozy-dark"
                        }`}
                    ...
                    <p
                        className={`text-sm sm:text-base leading-relaxed font-sans text-balance transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]/80"
                                : "text-cozy-dark/80"
                        }`}
                    >
                        Lưu lại những thước phim đời thường mộc mạc, những góc
                        làm việc ngăn nắp hay những cảm xúc vu vơ của tuổi trẻ
                        công sở đầy khát khao nhưng cũng cần vỗ về.
                    </p>
                </div>
                ...
                <div className="text-center max-w-sm mx-auto pt-8 space-y-3 border-t border-cozy-wood/10">
                    ...
                    <a
                        ...
                        className={`inline-flex items-center gap-1 text-sm font-bold uppercase tracking-wider underline transition-colors ${
                            activeTheme === "evening"
                                ? "text-cozy-warm-yellow hover:text-[#F2D7A5]"
                                : "text-cozy-wood hover:text-cozy-moss"
                        }`}
                    >
