    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div
                    className={`absolute inset-0 z-20 transition-all duration-[1500ms] ease-in-out ${getThemeOverlay()}`}
                />
            ...
            <div
                className="absolute bottom-1/4 right-10 md:right-32 text-[#66705A]/15 pointer-events-none select-none z-10 animate-drift"
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10 space-y-8 select-none">
                ...
                >
                    Một góc nhỏ dành cho những người đã có một ngày hơi dài. Bật
                    chút âm thanh rì rào, chọn một tâm trạng bất kỳ và ở lại đây
                ...
                >
                    ...
                    >
                        <Volume2
                            size={16}
                            className={`${isAudioPlaying ? "animate-bounce" : "group-hover:scale-110 transition-transform"}`}
                        />
                        Bật chế độ chill
                    </button>
                ...
                >
                    <p className="text-[10px] md:text-xs text-cozy-cream/55 italic">
                        Không quảng cáo ồn ào. Chỉ có những thứ khiến ngày của
                        bạn dễ chịu hơn.
                    </p>
                </motion.div>
            </div>
