...
export const ProductSection: React.FC<ProductSectionProps> = ({
    ...
    const filteredProducts = useMemo(() => {
        return products.filter((product) => {
            ...
            // Mood filter check
            const matchesMood =
                !selectedMoodId || product.moodIds.includes(selectedMoodId);
            // Search query check
            const matchesSearch =
                product.name
                    .toLowerCase()
      ...
      `}</style>
            ...
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="text-center space-y-3 max-w-2xl mx-auto">
                    <span
                        className={`text-xs sm:text-sm font-bold uppercase tracking-[0.25em] flex items-center justify-center gap-1.5 transition-colors ${
                            activeTheme === "evening"
                    ...
                    <h2
                        className={`font-serif text-2xl sm:text-3xl md:text-4xl font-semibold transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]"
                                : "text-cozy-dark"
                        }`}
                    ...
                    <p
                        className={`text-sm sm:text-base leading-relaxed font-serif italic transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]/80"
                                : "text-cozy-dark/85"
                        }`}
                    >
                        “Những đồ vật thầm lặng được tuyển lựa để vỗ về giác
                        quan, thắp sáng không gian riêng tư của bạn mỗi khi tan
                        ca.”
                    </p>
                </div>
                ...
                <div className="relative w-full overflow-hidden py-4 -mx-6 px-6 md:-mx-12 md:px-12">
                    ...
                    <div
                        className={`absolute inset-y-0 left-0 w-16 sm:w-28 z-10 pointer-events-none transition-all duration-1000 ${
                            activeTheme === "evening"
                                ? "from-[#181310] via-[#181310]/80 to-transparent"
                                : "from-[#FFFDF8] via-[#FFFDF8]/80 to-transparent"
                        }`}
                    />
                    <div
                        className={`absolute inset-y-0 right-0 w-16 sm:w-28 z-10 pointer-events-none transition-all duration-1000 ${
                            activeTheme === "evening"
                                ? "from-[#181310] via-[#181310]/80 to-transparent"
                                : "from-[#FFFDF8] via-[#FFFDF8]/80 to-transparent"
                        }`}
                    ...
                    <div className="flex w-max animate-marquee-chain gap-6 md:gap-8 hover:cursor-grab active:cursor-grabbing">
                        {marqueeProducts.map((product, idx) => (
                            ...
                            >
                                <ProductCard
                                    product={product}
                                    isFavorited={favoritedIds.includes(
                                        product.id,
                                    )}
                ...
                <div className="flex flex-col items-center justify-center pt-2 pb-6">
                    <button
                        onClick={() => {
                            setIsExpanded(true);
                            onToast(
                                "Mở tủ đồ chữa lành đầy đủ bộ lọc 🌿",
                                "info",
                            );
                        }}
                    ...
                    <p
                        className={`text-xs font-mono mt-3 tracking-tight uppercase transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]/50"
                                : "text-cozy-dark/50"
                        }`}
                    ...
                    {isExpanded && (
                        ...
                        >
                            ...
                            >
                                {/* Modal Header */}
                                <div
                                    className={`px-6 py-5 md:px-8 md:py-6 border-b flex flex-col gap-4 relative transition-colors ${
                                        activeTheme === "evening"
                                            ? "border-[#5A483B]/20"
                                            : "border-cozy-wood/5"
                                    }`}
                                >
                                    ...
                                    <button
                                        ...
                                        className={`absolute top-4 right-4 sm:top-5 sm:right-5 p-2 rounded-full transition-all duration-300 cursor-pointer ${
                                            activeTheme === "evening"
                                                ? "hover:bg-[#2D231D] text-[#EBE4DC]/65 hover:text-[#EBE4DC]"
                                                : "hover:bg-cozy-cream/40 text-cozy-dark/60 hover:text-cozy-dark"
                                        }`}
                                        title="Đóng cửa sổ"
                                    >
                                        <X size={18} />
                                    ...
                                    <div className="pr-12">
                                        <span
                                            className={`text-[9px] font-bold uppercase tracking-[0.2em] flex items-center gap-1 transition-colors ${
                                                activeTheme === "evening"
                                                    ? "text-cozy-warm-yellow"
                                                    : "text-cozy-moss"
                                            }`}
                                        >
                                            <Sparkles
                                                size={10}
                                                className="text-cozy-warm-yellow fill-cozy-warm-yellow animate-spin-slow"
                                            />
                                            KHÁM PHÁ TOÀN BỘ TỦ ĐỒ CHỮA LÀNH
                                        </span>
                                        <h3
                                            className={`font-serif text-lg sm:text-xl font-semibold leading-tight mt-1 transition-colors ${
                                                activeTheme === "evening"
                                                    ? "text-[#EBE4DC]"
                                                    : "text-cozy-dark"
                                            }`}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pt-1 items-end">
                                        ...
                                        <div className="md:col-span-6 space-y-1.5">
                                            <span
                                                className={`text-[9px] font-mono uppercase tracking-wider block pl-1 transition-colors ${
                                                    activeTheme === "evening"
                                                        ? "text-[#EBE4DC]/50"
                                                        : "text-cozy-dark/45"
                                                }`}
                                                ...
                                                {searchQuery && (
                                                    <button
                                                        ...
                                                        className={`absolute right-3 top-1/2 -translate-y-1/2 text-xs cursor-pointer font-bold ${
                                                            activeTheme ===
                                                            "evening"
                                                                ? "text-[#EBE4DC]/50 hover:text-[#EBE4DC]"
                                                                : "text-cozy-dark/40 hover:text-cozy-dark"
                                                        }`}
                                                    >
                                                        &times;
                                                    </button>
                                ...
                                <div className="flex-1 overflow-y-auto p-6 md:p-8 min-h-[250px]">
                                    {filteredProducts.length === 0 ? (
                                        ...
                                        <div className="py-16 text-center">
                                            <div
                                                className={`w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 ${
                                                    activeTheme === "evening"
                                                        ? "bg-[#241D19] text-[#EBE4DC]/30"
                                                        : "bg-cozy-wood/5 text-cozy-wood/30"
                                                }`}
                                            >
                                                <EyeOff size={20} />
                                            </div>
                                            ...
                                            <p
                                                className={`text-[11px] max-w-xs mx-auto leading-relaxed mt-1 font-sans transition-colors ${
                                                    activeTheme === "evening"
                                                        ? "text-[#EBE4DC]/60"
                                                        : "text-cozy-dark/60"
                                                }`}
                                            >
                                                Không tìm thấy mảnh ghép nào
                                                khớp với bộ lọc hoặc từ khóa "
                                                {searchQuery}". Bạn hãy thử
                                                reset lại nhé.
                                            </p>
                                            <button
                                                onClick={() => {
                                        ...
                                        <div className="space-y-4">
                                            <p
                                                className={`text-[10px] font-mono uppercase tracking-wider pl-1 transition-colors ${
                                                    activeTheme === "evening"
                                                        ? "text-[#EBE4DC]/40"
                                                        : "text-cozy-dark/40"
                                                }`}
                                            >
                                                Hiện có{" "}
                                                {filteredProducts.length} mảnh
                                                ghép được tuyển chọn tỉ mẩn:
                                            </p>
                                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
                                                {filteredProducts.map(
                                                    (product) => (
                                                        <div
                                                            key={`${product.id}-modal-grid`}
                                ...
                                {/* Modal Footer */}
                                <div
                                    className={`px-6 py-4 border-t text-center flex items-center justify-between transition-colors ${
                                        activeTheme === "evening"
                                ...
                                >
                                    <p
                                        className={`text-[9px] font-mono tracking-tight uppercase text-left transition-colors ${
                                            activeTheme === "evening"
                                                ? "text-[#EBE4DC]/30"
                                                : "text-cozy-dark/30"
                                        }`}
                                    >
                                        * Nhấn phím ESC hoặc click bên ngoài để
                                        đóng lại bất kỳ lúc nào
                                    </p>
                                    <button
                                        onClick={() => setIsExpanded(false)}
                ...
                >
                    <p
                        className={`text-xs font-mono tracking-tight max-w-xl mx-auto leading-relaxed uppercase transition-colors ${
                            activeTheme === "evening"
                                ? "text-[#EBE4DC]/50"
                                : "text-cozy-dark/60"
                        }`}
                    >
                        * Mỗi vật phẩm đều đã được giám định thực tế và liên kết
                        đến các nhà cung cấp uy tín trên TikTok Shop. Tan Ca Rồi
                        hỗ trợ chuyển giao phi lợi nhuận.
                    </p>
                </div>
            </div>
        </section>
